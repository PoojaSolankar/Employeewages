...
public class EmpWageBuilder2 {
	...
	public EmpWageBuilder2(String company, int empRatePerHour, int numOfWorkingDays, int maxHrsPerMonth)
	{
		super();
	...
	public static void main(String[] args) {
		EmpWageBuilder2 relience = new EmpWageBuilder2("Relince", 20, 2, 10);
